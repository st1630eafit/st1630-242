...
# LAB - part 1 - Logs Agent -> Kinesis Firehose -> S3 -> Glue -> Athena:
...
9. ejecute aws glue y consulte con aws athena los datos de S3 st1630orderlogs (opcional)

# LAB - Logs Agent -> Kinesis Data Streams -> Lambda -> DynamoDB:
